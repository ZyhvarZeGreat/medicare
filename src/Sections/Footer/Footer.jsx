...
const Footer = () => {
  ...
  return (
    ...
    <footer className="bg-white lg:h-[25rem]  w-full ">
      <div className="w-full max-w-[100%] h-full p-4 py-6 lg:py-8">
        <div className="md:flex h-[70%] items-center    md:justify-between">
          <div className="mb-6 flex items-center  md:mb-0 h-[12rem] w-[20rem]">
            <img src={logo} className=" object-cover mr-3 w-full h-full" alt="FlowBite Logo" />
          </div>
